...
class RiveDebugger extends StatefulWidget {
  ...
  /// Schema-aware runtime binding generated by RiveTelemetry tooling.
  ///
  /// When provided, this binding is the preferred source for artboard, state
  /// machine, ViewModel, and runtime handles. The older loose fields remain
  /// supported for hand-written integrations.
  final RiveTelemetryBinding? binding;
...
class _RiveDebuggerState extends State<RiveDebugger> {
  ...
  RiveTelemetryBinding? get _binding => widget.binding;
  rive.StateMachine? get _stateMachine =>
      _binding?.stateMachine ?? widget.stateMachine;
  rive.ViewModelInstance? get _viewModelInstance =>
      _binding?.viewModelInstance ?? widget.viewModelInstance;
  String? get _viewModelName => _binding?.viewModelName ?? widget.viewModelName;
  String? get _artboardName => _binding?.artboardName;
  String get _stateMachineName =>
      _binding?.stateMachineName ?? widget.stateMachineName;
  ...
  void _configureStateMachine() {
    ...
    if (_stateMachine == null && _viewModelInstance == null) {
      return;
    }
  ...
  Map<String, dynamic> _buildTelemetryPayload() {
    if (!_isTelemetryEnabled) {
      return {
        ...
        if (_artboardName != null) 'artboard': _artboardName,
  ...
  Map<String, dynamic> _serializeViewModelTelemetry() {
    return _viewModelTelemetryAdapter
        .capture(instance: _viewModelInstance, viewModelName: _viewModelName)
        .toJson();
  }
  ...
  String _buildInputSignature() {
    ...
    final inputs = _stateMachine?.inputs.map(_serializeInput).toList();
  ...
  void _handleSocketMessage(dynamic message) {
    ...
    _stateMachine?.requestAdvance();
    _viewModelInstance?.requestAdvance();
    _broadcastRiveState();
  }
  ...
  bool _applySetInputCommand(Map<String, dynamic> command) {
    ...
    if (command['stateMachine'] != _stateMachineName) {
  ...
  bool _applySetViewModelPropertyCommand(Map<String, dynamic> command) {
    ...
    if (command['viewModelName'] != _viewModelName) {
