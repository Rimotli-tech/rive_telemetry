...
class RiveTelemetryPanel {
    constructor(panel, context, telemetryServer) {
        ...
        this.panel.webview.html = getWebviewHtml(this.telemetryServer.panelState, this.telemetryServer.status, iconUri);
...
function getWebviewHtml(state, status, iconUri) {
